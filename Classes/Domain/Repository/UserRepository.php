...
class UserRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
    ...
    public function findByUidAndOpened (
    	PimentRouge\Pimentrougetickets\Domain\Model\User $uid, 
    ...
    /**
     *
     * @param \PimentRouge\Pimentrougetickets\Domain\User $adminGroup
     * @return void
     */
    public function findByGroup($adminGroup) {
    	$query = $this->createQuery();
    	return $query->matching(
    			$query->logicalAnd(
    					$query->equals('usergroup', $adminGroup)
    					)
    		)
    	->setOrderings(array(
    		'sorting' => \TYPO3\CMS\Extbase\Persistence\QueryInterface::ORDER_ASCENDING,
