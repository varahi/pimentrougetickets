<?php
namespace PimentRouge\Pimentrougetickets\Property\TypeConverter;
...
/**
 * Class UploadedFileReferenceAnswerConverter
 */
class UploadedFileReferenceAnswerConverter extends \TYPO3\CMS\Extbase\Property\TypeConverter\AbstractTypeConverter {
	 ...
	 * with no ObjectStorage annotation.
	 */
	const CONFIGURATION_ALLOWED_FILE_EXTENSIONS = 40;
	...
	protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration) {
		...
		$allowedFileExtensions = $configuration->getConfigurationValue('PimentRouge\\Pimentrougetickets\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
		...
		$uploadFolderId = $configuration->getConfigurationValue('PimentRouge\\Pimentrougetickets\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
		$conflictMode = $configuration->getConfigurationValue('PimentRouge\\Pimentrougetickets\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $this->defaultConflictMode;
		$replaceResource = (bool)$configuration->getConfigurationValue('PimentRouge\\Pimentrougetickets\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_REPLACE_RESOURCE);
	...
	/**
	 * @param File $file
	 * @return \PimentRouge\Pimentrougetickets\Domain\Model\FileReference
	 */
	...
	protected function createFileReferenceFromFalFileReferenceObject(FileReference $fileReference) {
		/** @var $fileReferenceModel \PimentRouge\Pimentrougetickets\Domain\Model\FileReference */
